...
class TestOrderCreation:
    ...
    def test_create_order_success(self, api_client, valid_order_data):
    ...
    def test_create_order_order_line_failure(self, api_client, invalid_order_line_data):
        response = api_client.post(
    ...
    def test_create_order_failure(self, api_client, invalid_order_data):
        response = api_client.post(
    ...
    def test_create_order_with_partial_data(self, api_client):
        partial_data = {
            'customer_id': '1000',
            'customer_PO': 'PO12345'
        ...
        response = api_client.post(
            '/orders/create/', partial_data, format='json')
