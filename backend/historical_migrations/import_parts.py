...
# Load the Excel file
# A: customer_id = models.CharField(max_length=10)
# B: part_number = models.TextField()
# C: dwg_number = models.TextField()
# D: revision = models.CharField(max_length=10)
# E: description = models.TextField(null=True, blank=True)
# F: price = models.FloatField()
# H: cost = models.FloatField()
# K: material = models.TextField(null=True, blank=True)
# L: weight = models.FloatField(null=True, blank=True)
# M: order_quantity = models.IntegerField(null=True, blank=True)
